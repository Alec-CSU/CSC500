#!/bin/python
"""
Goal of program: Create an object called 'ItemToPurchase' and 'ShoppingCart' for CSC500 Module 8 Portfolio Project.
"""
#Version 2.0.0
...
class ItemToPurchase:
    ...
    #DEFAULT CONSTRUCTER = ItemToPurchase("none", "none", 0.00, 0)
    #DEFAULT CONSTRUCTER: Forces inputs to be (str, str, float, int)
    def __init__(self,
                 item_name:str = "none",
    ...
    #print_item_cost Method: ItemToPurchase.print_item_cost will print ItemToPurchase("Bottled Watter", "Quench your Thirst" 1.00, 1) as "Bottled Water 1 @ $1.00 = $1.00".
            ...
            for ind in range(len(self.cart_items)):
                if self.cart_items[ind].item_name.upper() == item.item_name.upper():
                    if item.item_description != "none":
                        self.cart_items[ind].item_description = item.item_description

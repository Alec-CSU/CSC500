#!/bin/python
"""
Goal of program: Add menu and final user interaction for Module 8 'The ShoppingCart assignment'.
"""
#Version 2.0.0

import os
import time
from PythonCode_P1 import ItemToPurchase, ShoppingCart
...
#get_float_input Method: Keeps asking user for a float until valid input is provided.
def get_float_input(inp:str):
    while True:
        try:
...
#get_int_input Method: Keeps asking user for an integer until valid input is provided.
def get_int_input(inp:str):
    while True:
        try:
